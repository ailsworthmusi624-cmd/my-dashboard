    ...
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-300">
      ...
      <div className="glass-card p-4 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-primary/10 text-primary rounded-[16px] flex items-center justify-center shrink-0 shadow-sm">
            <BarChart3 size={24} />
          </div>
          <div>
        ...
        <div className="flex items-center gap-2 glass-inner rounded-2xl p-1.5">
          <input 
            type="month" 
            value={monthStr} 
      ...
      {/* Table */}
      <div className="glass-card overflow-hidden p-6 md:p-10 space-y-8">
        ...
        <section>
          ...
          <TableRow label="Валовая прибыль" value={metrics.grossProfit} isBold color="text-primary" />
        </section>
        ...
        <section>
          ...
          <div className="flex justify-between items-center py-4 px-4 glass-inner rounded-2xl mt-4">
        ...
        <section className="pt-6 border-t-2 border-slate-100">
          ...
          <div className="p-6 glass-inner rounded-2xl flex items-center gap-4">
            <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-primary shadow-sm"><TrendingUp size={24}/></div>
            <div>
