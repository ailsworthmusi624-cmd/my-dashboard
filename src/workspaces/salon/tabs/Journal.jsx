    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="space-y-6">
        {sortedDates.map((date) => {
          ...
          return (
            <div key={date} className="glass-card p-5 sm:p-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-5 pb-5 border-b border-slate-100">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs font-bold text-on-surface-variant glass-inner px-4 py-2.5 rounded-2xl">
              ...
              <div className="space-y-3">
                {Object.entries(mastersGroup).map(([masterName, mEntries]) => {
                  ...
                  return (
                    <div key={masterName} className="glass-inner rounded-2xl overflow-hidden transition-all">
                      <div 
        ...
        {sortedDates.length === 0 && (
          <div className="text-center py-16 glass-card border-dashed animate-in fade-in">
